...
Public Class frmBreakOut
    Dim userid As Integer = 0
    Dim username As String = String.Empty
    Dim pkemptrans As Integer = 0
    Private Sub frmBreakOut_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
                ...
                If mgremp.DataObject.RowsAffected > 0 Then
                    ...
                    Try
                        ...
                        If mgr.DataObject.RowsAffected > 0 Then
                            If mgr.Entity.bempbreak = True Then
