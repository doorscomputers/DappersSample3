    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            Try
                ...
                mgrstock.Entity.lastcost = CDec(ceCost.Value)
                mgrstock.Entity.lastprice = CDec(ceRetail.Value)
                mgrstock.Entity.lastwholesale = CDec(ceWholesale.Value)
                mgrstock.Entity.markup = CDec(ceMarkup1.Value)
                mgrstock.Entity.markup2 = CDec(ceMarkup2.Value)
                mgrstock.Entity.markup3 = CDec(ceMarkup3.Value)
                mgrstock.Entity.markup4 = CDec(ceMarkup4.Value)
                ...
                mgrstock.Entity.dtInsertdt = DateTime.Now
                mgrstock.Entity.dtLastUpdatedt = DateTime.Now
                mgrstock.Entity.sLastUpdateid = PDSAAppConfig.CurrentLoginID
