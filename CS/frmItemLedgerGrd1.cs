...
{
	public partial class frmItemLedgerGrd1
	{
		public frmItemLedgerGrd1()
		{
			InitializeComponent();
		}
		
		public void frmItemLedgerGrd1_FormClosed(object sender, FormClosedEventArgs e)
		{
			this.Dispose();
		}
		
		public void frmItemLedgerGrd1_Load(object sender, EventArgs e)
		{
			//TODO: This line of code loads data into the 'DsvwItemLedger.vwItemLedger' table. You can move, or remove it, as needed.
			this.VwItemLedgerTableAdapter.Fill(this.DsvwItemLedger.vwItemLedger);
