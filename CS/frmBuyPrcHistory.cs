...
{
	public partial class frmBuyPrcHistory
	{
		public frmBuyPrcHistory()
		{
			InitializeComponent();
		}
		
		public void frmBuyPrcHistory_FormClosed(object sender, FormClosedEventArgs e)
		{
			this.Dispose();
		}
		
		public void frmBuyPrcHistory_Load(object sender, EventArgs e)
		{
			//TODO: This line of code loads data into the 'DsBuyPrice.vwBuyPriceHistory' table. You can move, or remove it, as needed.
			this.VwBuyPriceHistoryTableAdapter.Fill(this.DsBuyPrice.vwBuyPriceHistory);
