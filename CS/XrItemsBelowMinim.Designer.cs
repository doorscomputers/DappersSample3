...
namespace DoorsPOS.WinApp
{
	...
	partial class XrItemsBelowMinim : DevExpress.XtraReports.UI.XtraReport
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
			...
			//XrTable1
			//
			this.XrTable1.LocationFloat = new DevExpress.Utils.PointFloat((float) (10.00001F), (float) (0.0F));
			...
			//XrTableRow1
			//
			this.XrTableRow1.Cells.AddRange(new DevExpress.XtraReports.UI.XRTableCell[] {this.XrTableCell1, this.XrTableCell2, this.XrTableCell3, this.XrTableCell4});
			...
			this.XrTableCell1.Weight = 1.7541667175292968D;
			//
			//XrTableCell2
			//
			...
			this.XrTableCell2.Weight = 0.45833328247070315D;
			//
			//XrTableCell3
			//
			...
			this.XrTableCell3.Weight = 0.3854165649414063D;
			//
			//XrTableCell4
			//
			...
			this.XrTableCell4.Weight = 0.5833334350585937D;
			//
			//TopMargin
			//
			this.TopMargin.HeightF = (float) (17.0F);
			...
			this.BottomMargin.HeightF = (float) (27.08333F);
			...
			this.XrPageInfo1.LocationFloat = new DevExpress.Utils.PointFloat((float) (10.00001F), (float) (34.375F));
			...
			this.XrLabel1.SizeF = new System.Drawing.SizeF((float) (709.5417F), (float) (23.95834F));
			this.XrLabel1.StylePriority.UseFont = false;
			this.XrLabel1.StylePriority.UseTextAlignment = false;
			this.XrLabel1.Text = "ITEMS BELOW MINIMUM RE-ORDER LEVEL";
			...
			this.FilterString = "[available] <= [minimum]";
			this.Margins = new System.Drawing.Printing.Margins(72, 42, 17, 27);
