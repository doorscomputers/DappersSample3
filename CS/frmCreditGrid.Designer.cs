...
namespace DoorsPOS.WinApp
{
	...
	partial class frmCreditGrid : System.Windows.Forms.Form
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
			...
			base.Load += new System.EventHandler(frmCreditGrid_Load);
			...
			this.GridControl1.Size = new System.Drawing.Size(796, 477);
			...
			//GridView1
			//
			this.GridView1.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.colpos_date, this.Customer, this.colitem_desc, this.colprice, this.colqty, this.coldet_amnt, this.colBalance});
			this.GridView1.GridControl = this.GridControl1;
			this.GridView1.GroupCount = 3;
			this.GridView1.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Balance", this.colBalance, ""), new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "det_amnt", this.coldet_amnt, "SUM={0:N2}")});
			this.GridView1.Name = "GridView1";
			this.GridView1.OptionsBehavior.Editable = false;
			this.GridView1.SortInfo.AddRange(new DevExpress.XtraGrid.Columns.GridColumnSortInfo[] {new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.Customer, DevExpress.Data.ColumnSortOrder.Ascending), new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.colBalance, DevExpress.Data.ColumnSortOrder.Ascending), new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.colpos_date, DevExpress.Data.ColumnSortOrder.Ascending), new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.coldet_amnt, DevExpress.Data.ColumnSortOrder.Ascending)});
			//
			//colpos_date
			//
			...
			this.coldet_amnt.Caption = "Credit Amount";
			...
			//colBalance
			//
			this.colBalance.Caption = "B A L A N C E";
			...
			this.Name = "frmCreditGrid";
			this.Text = "Customer Credits Grid";
