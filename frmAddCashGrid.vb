...
Public Class frmAddCashGrid

    Private Sub frmAddCashGrid_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub frmAddCashGrid_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.AdditnlcashTableAdapter.Fill(Me.DsAddCash.additnlcash)
