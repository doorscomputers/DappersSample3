...
Partial Public Class dsBank
    ...
    Partial Public Class bankDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddbankRow(ByVal bank As String, ByVal accountno As String, ByVal accountname As String, ByVal Balance As Decimal) As bankRow
            Dim rowbankRow As bankRow = CType(Me.NewRow,bankRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, bank, accountno, accountname, Balance}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindBybankid(ByVal bankid As Integer) As bankRow
    ...
    Partial Public Class bankRow
        ...
        Public Property bankid() As Integer
            Get
                Return CType(Me(Me.tablebank.bankidColumn), Integer)
            End Get
        ...
        Public Property accountno() As String
            Get
                Return CType(Me(Me.tablebank.accountnoColumn), String)
            End Get
            Set(value As String)
                Me(Me.tablebank.accountnoColumn) = value
            End Set
        End Property
        ...
        Public Function IsaccountnameNull() As Boolean
            Return Me.IsNull(Me.tablebank.accountnameColumn)
        End Function

        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Sub SetaccountnameNull()
            Me(Me.tablebank.accountnameColumn) = Global.System.Convert.DBNull
        End Sub

        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Function IsBalanceNull() As Boolean
            Return Me.IsNull(Me.tablebank.BalanceColumn)
        End Function

        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Sub SetBalanceNull()
            Me(Me.tablebank.BalanceColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace dsBankTableAdapters
    ...
    Partial Public Class bankTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [bank] WHERE (([bankid] = @Original_bankid) AND ([bank] = @Original_b" & _
                "ank) AND ([accountno] = @Original_accountno) AND ((@IsNull_accountname = 1 AND [" & _
                "accountname] IS NULL) OR ([accountname] = @Original_accountname)) AND ((@IsNull_" & _
                "Balance = 1 AND [Balance] IS NULL) OR ([Balance] = @Original_Balance)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_bankid", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "bankid", Global.System.Data.DataRowVersion.Original, False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [bank] ([bank], [accountno], [accountname], [Balance]) VALUES (@bank," & _
                " @accountno, @accountname, @Balance);" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT bankid, bank, accountno, accountna" & _
                "me, Balance FROM bank WHERE (bankid = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [bank] SET [bank] = @bank, [accountno] = @accountno, [accountname] = @acco" & _
                "untname, [Balance] = @Balance WHERE (([bankid] = @Original_bankid) AND ([bank] =" & _
                " @Original_bank) AND ([accountno] = @Original_accountno) AND ((@IsNull_accountna" & _
                "me = 1 AND [accountname] IS NULL) OR ([accountname] = @Original_accountname)) AN" & _
                "D ((@IsNull_Balance = 1 AND [Balance] IS NULL) OR ([Balance] = @Original_Balance" & _
                ")));" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT bankid, bank, accountno, accountname, Balance FROM bank WHERE (bank" & _
                "id = @bankid)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_bankid", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "bankid", Global.System.Data.DataRowVersion.Original, False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@bankid", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "bankid", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        bankid, bank, accountno, accountname, Balance" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            bank" & _
                ""
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As dsBank.bankDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As dsBank.bankDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As dsBank.bankDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataSet As dsBank) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_bankid As Integer, ByVal Original_bank As String, ByVal Original_accountno As String, ByVal Original_accountname As String, ByVal Original_Balance As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overridable Overloads Function Insert(ByVal bank As String, ByVal accountno As String, ByVal accountname As String, ByVal Balance As Global.System.Nullable(Of Decimal)) As Integer
            If (bank Is Nothing) Then
                Throw New Global.System.ArgumentNullException("bank")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(bank, String)
            End If
        ...
        Public Overridable Overloads Function Update(ByVal bank As String, ByVal accountno As String, ByVal accountname As String, ByVal Balance As Global.System.Nullable(Of Decimal), ByVal Original_bankid As Integer, ByVal Original_bank As String, ByVal Original_accountno As String, ByVal Original_accountname As String, ByVal Original_Balance As Global.System.Nullable(Of Decimal), ByVal bankid As Integer) As Integer
            If (bank Is Nothing) Then
                Throw New Global.System.ArgumentNullException("bank")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(bank, String)
            End If
            If (accountno Is Nothing) Then
                Throw New Global.System.ArgumentNullException("accountno")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_bankid, Integer)
            If (Original_bank Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_bank")
            Else
            ...
            If (Original_accountno Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_accountno")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_accountno, String)
            End If
            If (Original_accountname Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(11).Value = CType(bankid, Integer)
        ...
        Public Overridable Overloads Function Update(ByVal bank As String, ByVal accountno As String, ByVal accountname As String, ByVal Balance As Global.System.Nullable(Of Decimal), ByVal Original_bankid As Integer, ByVal Original_bank As String, ByVal Original_accountno As String, ByVal Original_accountname As String, ByVal Original_Balance As Global.System.Nullable(Of Decimal)) As Integer
            Return Me.Update(bank, accountno, accountname, Balance, Original_bankid, Original_bank, Original_accountno, Original_accountname, Original_Balance, Original_bankid)
        End Function
    End Class
