...
Public Class frmTimeOut
    ...
    Private Sub frmTimeOut_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
                ...
                If mgremp.DataObject.RowsAffected > 0 Then
                    ...
                    Try
                        ...
                        If mgr.DataObject.RowsAffected > 0 Then
                            If mgr.Entity.bempbreak = True And mgr.Entity.bempbreakin = False Then
