Public Class frmExpenseGrid

    Private Sub frmExpenseGrid_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub frmExpenseGrid_Load(sender As Object, e As EventArgs) Handles MyBase.Load
