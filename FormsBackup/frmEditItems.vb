...
Public Class frmEditItems
    ...
    Sub SearchBarcode()
        ...
        mgrstock.DataObject.Entity.barcode = txtBarcode.Text
        ...
        If mgrstock.DataObject.RowsAffected > 0 Then
            ...
            ceWholesale.Value = mgrstock.Entity.wsale
            lastWholeSale = mgrstock.Entity.wsale
            ...
            ceIncentive.Value = mgrstock.Entity.incentive
        ...
        Else
            ...
            Try
                ...
                If mgrstockk.DataObject.RowsAffected > 0 Then
                    ...
                    mgrstockk.DataObject.Entity.available = ceAvlbl.Value
                    ...
                    mgrstockk.Entity.retail2 = CDec(retail2.Value)
                    ...
                    mgrstockk.Entity.vat = 1
                    mgrstockk.Entity.active = CBool(chkIncentive.EditValue)
                    mgrstockk.Entity.incentive = CDec(ceIncentive.Value)
