...
Partial Public Class dsCategory
    ...
    Partial Public Class categoriesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByCATEGORYID(ByVal CATEGORYID As Decimal) As categoriesRow
    ...
    Partial Public Class categoriesRow
        ...
        Public Property CATEGORYID() As Decimal
            Get
                Return CType(Me(Me.tablecategories.CATEGORYIDColumn),Decimal)
            End Get
            Set
...
Namespace dsCategoryTableAdapters
    ...
    Partial Public Class categoriesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CATEGORYID", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 4, 0, "CATEGORYID", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[categories] ([CATEGORY]) VALUES (@CATEGORY);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CATEGORYI"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[categories] SET [CATEGORY] = @CATEGORY WHERE (([CATEGORYID] = @Orig"& _ 
                "inal_CATEGORYID) AND ((@IsNull_CATEGORY = 1 AND [CATEGORY] IS NULL) OR ([CATEGOR"& _ 
                "Y] = @Original_CATEGORY)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CATEGORYID, CATEGORY FROM categories WHERE ("& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CATEGORYID", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 4, 0, "CATEGORYID", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CATEGORYID", Global.System.Data.SqlDbType.[Decimal], 5, Global.System.Data.ParameterDirection.Input, 4, 0, "CATEGORYID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CATEGORYID As Decimal, ByVal Original_CATEGORY As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_CATEGORYID,Decimal)
        ...
        Public Overloads Overridable Function Update(ByVal CATEGORY As String, ByVal Original_CATEGORYID As Decimal, ByVal Original_CATEGORY As String, ByVal CATEGORYID As Decimal) As Integer
            If (CATEGORY Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(CATEGORY,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(1).Value = CType(Original_CATEGORYID,Decimal)
            If (Original_CATEGORY Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(CATEGORYID,Decimal)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CATEGORY As String, ByVal Original_CATEGORYID As Decimal, ByVal Original_CATEGORY As String) As Integer
            Return Me.Update(CATEGORY, Original_CATEGORYID, Original_CATEGORY, Original_CATEGORYID)
        End Function
    End Class
