...
Public Class frmChangePrceGrid

    Private Sub frmChangePrceGrid_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub frmChangePrceGrid_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.VwChangePriceTableAdapter.Fill(Me.DsChangePrice.vwChangePrice)
