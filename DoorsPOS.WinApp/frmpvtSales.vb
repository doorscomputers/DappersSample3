...
Public Class frmpvtSales

    Private Sub frmpvtSales_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub frmpvtSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
