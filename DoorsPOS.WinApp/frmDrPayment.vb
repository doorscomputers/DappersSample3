...
Public Class frmDrPayment
    ...
    Sub SendItemtoGrid()
        ...
        End Try
    End Sub
    Private Sub txtremarks_LostFocus(sender As Object, e As EventArgs)
        ledrs.Focus()
    End Sub
    ...
    Private Sub textOfNumber()
        ...
        '   Me.txtremarks.RightToLeft = Windows.Forms.RightToLeft.No
        '  Me.txtremarks.Text = oTextNum.translateNumber(CStr(valid(Me.ceAmount.Text)), Language_ID.English)
