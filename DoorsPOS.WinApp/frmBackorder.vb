...
Public Class frmBackorder
    Dim mgr8 As stocksManager

    Private Sub frmBackorder_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub frmBackorder_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmBackorder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
