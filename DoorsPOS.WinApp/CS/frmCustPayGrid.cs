...
{
	public partial class frmCustPayGrid
	{
		public frmCustPayGrid()
		{
			InitializeComponent();
		}
		
		public void frmCustPayGrid_FormClosed(object sender, FormClosedEventArgs e)
		{
			this.Dispose();
		}
		
		public void frmCustPayGrid_Load(object sender, EventArgs e)
		{
			//TODO: This line of code loads data into the 'DsCustPay.vwCustPayments' table. You can move, or remove it, as needed.
			this.VwCustPaymentsTableAdapter.Fill(this.DsCustPay.vwCustPayments);
