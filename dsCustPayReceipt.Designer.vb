...
Namespace dsCustPayReceiptTableAdapters
    ...
    Partial Public Class paymentTableAdapter
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As dsCustPayReceipt.paymentDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As dsCustPayReceipt.paymentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
