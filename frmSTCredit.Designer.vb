...
Partial Class frmSTCredit
    ...
    Private Sub InitializeComponent()
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1094, 483)
        ...
        'GridView1
        '
        Me.GridView1.ActiveFilterString = "IsOutlookIntervalToday([dtInsert_dt]) And [custid] <> 1 And [qty] > 0.0"
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colReceipt, Me.colcustid, Me.collastname, Me.colfirstname, Me.coldtInsert_dt, Me.colitem_desc, Me.colqty, Me.colprice, Me.GridColumn1, Me.FullName, Me.colsInsert_id})
        ...
        Me.GridView1.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.FullName, DevExpress.Data.ColumnSortOrder.Ascending), New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.coldtInsert_dt, DevExpress.Data.ColumnSortOrder.Ascending)})
        '
        'colcustid
        '
        ...
        Me.colitem_desc.VisibleIndex = 4
        Me.colitem_desc.Width = 208
        '
        'colqty
        '
